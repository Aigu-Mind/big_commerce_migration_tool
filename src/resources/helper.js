...
export const getFormattedPrice = (price, decimal = 2, currency = "£") => {
  return `${currency}${parseFloat(price).toFixed(decimal)}`;
};
...
export const formRegExReplacer = "$1 $2"; //might have to change $ to £
